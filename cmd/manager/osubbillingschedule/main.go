...
func init() {
	...
	utilruntime.Must(osubbillingschedulev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "osubbillingschedule",
		LeaderElectionID:   "40558063.oci.osubbillingschedule",
		SkipFIPS:           true,
	}, managerservices.ForGroup("osubbillingschedule")); err != nil {
		os.Exit(1)
	}
}
