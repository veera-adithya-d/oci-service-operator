...
// UserCapabilityCapabilities defines nested fields for UserCapability.Capabilities.
type UserCapabilityCapabilities struct {
	// Indicates if the user can log in to the console.
	CanUseConsolePassword bool `json:"canUseConsolePassword,omitempty"`
	// Indicates if the user can use API keys.
	CanUseApiKeys bool `json:"canUseApiKeys,omitempty"`
...
type UserCapabilityStatus struct {
	...
	Capabilities UserCapabilityCapabilities `json:"capabilities,omitempty"`
